...
package org.openmrs.module.rks.util;
...
public class DateUtils {
	...
	public static SimpleDateFormat DDMMYYYY_HHMM = new SimpleDateFormat("ddMMyyyy-HHmm");
	public static SimpleDateFormat formatterDDMMYYYY = new SimpleDateFormat("dd/MM/yyyy");
	public static SimpleDateFormat formatterYYYYMMDD = new SimpleDateFormat("yyyyMMdd");
	public static SimpleDateFormat formatterYYYYMMDDEx = new SimpleDateFormat("yyyy-dd-MM HH:mm:ss");
	public static SimpleDateFormat formatterYYYY = new SimpleDateFormat("yyyy");
	public static SimpleDateFormat formatterMM = new SimpleDateFormat("MM");
	public static SimpleDateFormat formatterYYMMDD = new SimpleDateFormat("yy-MM-dd");
	/**
	 * <p> Method: main() </p>
